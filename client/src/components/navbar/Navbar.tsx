...
function Navbar() {
  ...
  return (
    <header className='blur-backdrop-filter  sticky top-0 z-10  w-full bg-zinc-900 bg-opacity-80 bg-clip-padding py-2 text-white xs:bg-violet-900 sm:bg-blue-900 md:bg-red-900 md:px-12 lg:bg-green-900 xl:bg-cyan-900 2xl:bg-violet-900'>
